...
export let Z2 = {
  ...
  draw: function (x, y) {
    (currentShape[0] = Z2), drawBlock(x, y);
    drawBlock(x, y + 25);
    drawBlock(x - 25, y + 25);
    drawBlock(x - 25, y + 50);
  },
    ...
    if (game.running) {
      ...
      this.timeoutId = setTimeout(() => {
        if (this.downMoveable) {
          ...
          occupy();
          dropAndClear();
          checkGameOver(this, game.indexA, game.indexC);
  ...
  updateMovability: function () {
    ...
    this.rightMoveable = checkRight(game.indexA, game.indexB, game.indexD);
  ...
  updateRotability: function () {
    this.rotable1 =
      checkEmpty(game.indexD + 1, game.indexD + 2) &&
      checkSameRow(game.indexD + 1, game.indexD + 2);
    this.rotable2 =
      checkEmpty(game.indexD + 1, game.indexD + 2) &&
      checkSameRow(game.indexD + 1, game.indexD + 2);
