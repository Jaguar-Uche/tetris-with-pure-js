...
export let J2 = {
  ...
  updateMovability: function () {
    this.leftMoveable = checkLeft(game.indexA, game.indexB);
    this.rightMoveable = checkRight(game.indexA, game.indexD);
  ...
  updateRotability: function () {
    this.rotable1 =
      checkEmpty(game.indexB + 20, game.indexB + 19) &&
      checkSameRow(game.indexB + 20, game.indexB + 19);
    this.rotable2 = checkEmpty(game.indexA + 1, game.indexB + 20);
    this.rotable3 = checkEmpty(game.indexA + 1, game.indexA + 2);
    this.rotable4 = checkEmpty(game.indexA + 1, game.indexA + 2);
  },
};
