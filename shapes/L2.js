...
export let L2 = {
  ...
  draw: function (x, y) {
    (currentShape[0] = L2), drawBlock(x, y);
    drawBlock(x, y + 25);
    drawBlock(x + 25, y);
    drawBlock(x + 50, y);
  },
  ...
  updateRotability: function () {
    this.rotable1 = checkEmpty(game.indexD + 20, game.indexD + 21);
    this.rotable2 = checkEmpty(game.indexD + 1, game.indexD + 21);
    this.rotable3 = checkEmpty(game.indexD + 1, game.indexD + 2);
    this.rotable4 = checkEmpty(game.indexD + 1, game.indexD + 2);
  },
};
