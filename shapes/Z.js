...
export let Z = {
  ...
  draw: function (x, y) {
    (currentShape[0] = Z), drawBlock(x, y);
    drawBlock(x, y + 25);
    drawBlock(x - 25, y);
    drawBlock(x + 25, y + 25);
  },
  ...
  updateRotability: function () {
    this.rotable1 = checkEmpty(game.indexB + 1, game.indexC + 20);
    this.rotable2 = checkEmpty(game.indexB + 1, game.indexC + 20);
    this.rotable3 = checkEmpty(game.indexB + 1, game.indexC - 1);
    this.rotable4 = checkEmpty(game.indexB + 1, game.indexC - 1);
  },
};
